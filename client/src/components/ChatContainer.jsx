...
const ChatContainer = () => {
  const { messages, selectedUser, setSelectedUser, getMessages, sendMessages } = useContext(ChatContext);
  ...
  const handleSendImage = async (e) => {
    ...
    const reader = new FileReader(); //chuyển hình ảnh thành chuỗi Base64 (Data URL)
